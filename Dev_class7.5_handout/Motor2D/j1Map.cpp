...
void j1Map::PropagateBFS()
{
	...
	if (frontier.GetLast() != nullptr)
	{
		...
		if (IsWalkable(point.x,point.y))
		{
			...
			if (visited.find({ point.x + 0, point.y + 1 }) == -1)
			{
				...
				if (frontier.start != nullptr)
				{
					...
					{
						iPoint frotierpeek = *(frontier.Peek(i));
						if (frotierpeek.operator==({ point.x + 0, point.y + 1 }))
						{
							isFrontier = true;
						}
					}
					if (isFrontier == false)
					{
						frontier.Push({ point.x + 0, point.y + 1 });
					}
				}
				else
				{
			...
			if (visited.find({ point.x + 1, point.y }) == -1)
			{
				bool isFrontier = false;
				if (frontier.start != nullptr)
				{
					...
					{
						iPoint frotierpeek = *(frontier.Peek(i));
						if (frotierpeek.operator==({ point.x + 1, point.y }))
						{
							isFrontier = true;
						}
					}
					if (isFrontier == false)
					{
						frontier.Push({ point.x + 1, point.y });
					}
				}
				else
				{
